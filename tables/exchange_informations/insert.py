...
from ..table import _process_chunk as process_chunk
from core.between_range import MydatabaseRange
from fastapi import status
from core.logger import get_logger

logger = get_logger("exchange_informations")
...
def insert_exchange_informations_between_range(
    ...
    namespace, table_name = "order_fulfillment", "exchange_informations"
    ...
    try:
        ...
        rows = mysql_creds.get_exchange_informations(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from exchange_informations")

...
from date_between.scheduler_retention_logUtility import *

def scheduler_retention_log_between_date():

    namespace =  "order_fulfillment"
    table_name = "scheduler_retention_log"
    dbname = "scheduler_retention_log"
    chunk_size = 1000
    ...
    with MysqlCatalog() as mysql:
        ...
        rows = fetch_mysql_date_range(
            mysql_client=mysql,
            dbname=dbname,
            fetch_fn=mysql.get_scheduler_retention_log_date_between,

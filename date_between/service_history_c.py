...
from date_between.service_history_cUtility import *

def service_history_c_between_date():

    namespace, table_name = "order_fulfillment", "service_history_c"
    dbname = "service_history_c"
    chunk_size = 1000
    ...
    with MysqlCatalog() as mysql:
        rows = fetch_mysql_date_range(
            mysql_client=mysql,
            dbname=dbname,
            fetch_fn=mysql.get_service_history_c_date_between,
...
def run():
    return service_history_c_between_date()

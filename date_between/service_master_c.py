...
from .service_master_cUtility import (REQUIRED_FIELDS,FIELD_OVERRIDES,
...
url_prefix = "service_master_c"

logger = get_logger("service_master_c")
...
def insert_service_master_c_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_service_master_c(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_service_master_c")

...
from date_between.intransit_pickup_delivery_itemsUtility import *


def intransit_pickup_delivery_items_between_date():
    ...
    last_val = get_last_date_value(namespace, table_name, "row_added_dt")
...
def run():
    return intransit_pickup_delivery_items_between_date()

...
from date_between.service_master_hUtility import *
from date_between.utility import *

def service_master_h_between_date():

    namespace = "order_fulfillment"
    table_name = "service_master_h"
    dbname = "service_master_h"
    chunk_size = 1000
    ...
    with MysqlCatalog() as mysql:
        ...
        rows = fetch_mysql_date_range(
            mysql_client=mysql,
            dbname=dbname,
            fetch_fn=mysql.get_service_master_h_date_between,
...
def run():
    return service_master_h_between_date()

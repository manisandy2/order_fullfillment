...
from date_between.orderlineitemsUtility import *

def orderlineitems_between_date():
    ...
    with MysqlCatalog() as mysql:
        rows = fetch_mysql_date_range(
            mysql_client=mysql,
            dbname=dbname,
            fetch_fn=mysql.get_orderlineitems_date_between,
...
def run():
    return orderlineitems_between_date()

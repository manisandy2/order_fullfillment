...
from date_between.pickup_delivery_items_w_Utility import *

def pickup_delivery_items_w_between_date():
    ...
    with MysqlCatalog() as mysql:
        rows = fetch_mysql_date_range(
            mysql_client=mysql,
            dbname=dbname,
            fetch_fn=mysql.get_pickup_delivery_items_w_date_between,
...
def run():
    return pickup_delivery_items_w_between_date()

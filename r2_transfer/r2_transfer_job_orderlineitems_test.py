...
API_URL = "http://127.0.0.1:8000/orderlineitems_test/insert-multi-with-mysql"  # FastAPI endpoint
...
SUCCESS_LOG_FILE = "logs/success_orderlineitems_test.log"
FAILED_LOG_FILE = "logs/error_orderlineitems_test.log"

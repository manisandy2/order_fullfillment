...
def insert_shipments_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_shipments(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_shipments")

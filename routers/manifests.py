...
def insert_manifests_between_range(
    ...
    namespace, table_name = "order_fulfillment", "manifests"
    dbname = "manifests"
    ...
    try:
        ...
        rows = mysql_creds.get_manifests(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_manifests")

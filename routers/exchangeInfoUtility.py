...
FIELD_OVERRIDES = {
    ...
    # Nullable Varchars & Text (Explicit Mappings)
    ...
    # Value fields (Varchar in schema, keeping as String to match source)
...
def exchange_info_schema(record: Dict[str, Any]) -> Tuple[Schema, pa.Schema]:
    """
...
def exchange_info_clean_rows(rows: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """

...
url_prefix = "service_master_h"

logger = get_logger("service_master_h")
...
def insert_service_master_h_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_service_master_h(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_service_master_h")

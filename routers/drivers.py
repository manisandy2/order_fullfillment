...
def drivers_between_range(
    ...
    namespace, table_name = "order_fulfillment", "drivers"
    dbname = "drivers"
    ...
    try:
        ...
        rows = mysql_creds.get_drivers(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from drivers")

...
from .usersUtility import (REQUIRED_FIELDS,FIELD_OVERRIDES,
...
def insert_users_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_users(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_users")

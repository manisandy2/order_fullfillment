...
url_prefix = "schedulers_w"

logger = get_logger("schedulers_w")
...
def insert_schedulers_w_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_schedulers_w(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_schedulers_w")

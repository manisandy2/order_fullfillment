...
from .scheduler_retention_logUtility import *
...
logger = get_logger("scheduler_retention_log")
...
def insert_scheduler_retention_log_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_scheduler_retention_log(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_scheduler_retention_log")

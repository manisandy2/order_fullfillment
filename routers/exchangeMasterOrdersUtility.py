...
def exchange_masterorders_schema(record: Dict[str, Any]) -> Tuple[Schema, pa.Schema]:
    """
...
def exchange_masterorders_clean_rows(rows: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """

...
from .service_history_hUtility import (REQUIRED_FIELDS,FIELD_OVERRIDES,
...
url_prefix = "service_history_h"

logger = get_logger("service_history_h")
...
def insert_service_history_h_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_service_history_h(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_service_history_h")

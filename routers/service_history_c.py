...
from .service_history_cUtility import (REQUIRED_FIELDS,FIELD_OVERRIDES,
...
logger = get_logger("service_history_c")
...
def insert_service_history_c_between_range(
    ...
    try:
        ...
        rows = mysql_creds.get_service_history_c(dbname, start_range, end_range)
        print(f"{len(rows)} rows fetched from get_service_history_c")
